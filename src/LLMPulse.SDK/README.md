...
inputSpec: /local/.generation-tmp/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{9EB651EA-DA22-4AA1-8F47-355E23BFFDA2}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAIAgentTrafficApi>();
            IGetAgentTrafficApiResponse apiResponse = await api.GetAgentTrafficAsync("todo");
            AgentTrafficResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: LLM Pulse API
- appVersion: 1.46.0
- appDescription: REST API client for LLM Pulse AI visibility analytics.
