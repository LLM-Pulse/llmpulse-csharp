...
inputSpec: /local/integrations/sdks/.generation-tmp/openapi.json
outputDir: out
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAIModelInsightsApi>();
            IGetAiModelInsightsSummaryApiResponse apiResponse = await api.GetAiModelInsightsSummaryAsync("todo");
